...
> Source: [https://rlgym.org/Getting%20Started/quickstart/](https://rlgym.org/Getting%20Started/quickstart/)  
...
For a more complete guide to training your first agent, refer to our Rocket League tutorial on [training an agent](</Rocket League/training_an_agent>).
