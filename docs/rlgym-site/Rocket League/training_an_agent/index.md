...
> Source: [https://rlgym.org/Rocket%20League/training_an_agent/](https://rlgym.org/Rocket%20League/training_an_agent/)  
> Scraped for local reference from the public RLGym docs.

# Training an Agent

This guide builds on our [Quick Start Guide](</Getting Started/quickstart>) to help you train a more sophisticated Rocket League bot than the simple setup in the quickstart guide. We'll use RocketSim to run training much faster than the actual game, and cover all the key concepts you need to know.
